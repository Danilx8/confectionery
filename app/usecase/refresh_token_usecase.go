...
func (rtu *refreshTokenUsecase) ExtractRoleFromToken(requestToken string, secret string) (string, error) {
	return tokenutil.ExtractRoleFromToken(requestToken, secret)
}
